...
本模板用于撰写中国科学院软件研究所硕士学位论文，此分支 master-iscas 在 master 分支基础上，根据中国科学院软件研究所关于学位论文撰写格式(2015)的规定，进行了定制。
...
另外，软件所的 zzq 同学在 ucasthesis 论文模板(master 分支）的基础上，对页面设置，字体，版权页等进行了设置。
